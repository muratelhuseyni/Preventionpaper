...
In each iteration, dgg is zeros matrxi which is later used for dg (fmax values). For fmax values bigger than 0
random values are generated by giving our desired numerical range. Later, the matrix is turned to
a symetric matrix. 
...
The rest of the code is similar to the enumeration code where bids are generated and tested in order to check whether the 
