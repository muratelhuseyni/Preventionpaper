...
#for typ in range(0,1):  
 
 probtime = 0       
 input_file2='C:\\Users\\labuser\\Desktop\\python\\alpha input alpha3=1.xlsx'
 ...
 #for ind in range(1,2):
       ...
       if typ == 0:
           output_file2 = 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_Smallsummary.csv'
       elif typ == 1:
           output_file2 = 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_Mediumsummary.csv'
       elif typ == 2:
           output_file2 = 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_Medium+summary.csv'
       else:
           output_file2 = 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_Bigsummary.csv'
       
       
       output_file3 = 'score' + str(typ) + '_Detect.csv' 
       
       with open(output_file3,"a") as f:   
           f.write("alp1\t" + "alp2\t" + "alp3\t"+ "score\t"+ "time\t"+ "#master\t"+ "#enum\t"+ "#iter\n")
       ...
       with open(output_file2,"a") as f:
            f.write("Case\tTotprof\tPenalty\tRevtrans\tcolpreventstate\tTime\t#master\t#totenum\t#iter\n") 
             
       for prob in range(1,inst+1): #1'den inst'e kadar 
       #for prob in range(3,5):
     ...
     #       print(prob)
      #      continue
            ...
            if typ == 0:            
                ...
                output_file= 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_SmallTrials.csv'
                ...
                if typ == 1:
                    ...
                    output_file= 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_MediumTrials.csv'
                               
                    with open(output_file,"a") as f:  
                        f.write("Medium"+str(prob)+"\n")  
                else:
                    input_file='C:\\Users\\labuser\\Desktop\\python\\trileveldata\\Medium+ '+str(prob)+'.xlsx'  
                    output_file= 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_Medium+Trials.csv'
                    ...
                    input_file='C:\\Users\\hp\\Desktop\\Python Scripts\\trileveldata\\Big Problem '+str(prob)+'.xlsx'                
                    output_file= 'alp1_' + str(round(alpha1,1)) + 'alp2_' + str(round(alpha2,1)) + 'alp3_' + str(round(alpha3,1)) + '_Detect_BigTrials.csv'
            ...
            def Updatecollusives(collusives,col,lambdaa,DCOPF_matrix,count):
            ...
            def WriteEnumeration(flow_list, congested_list, revtrans,lmp,Phi,Psineg,Psipos,Profit,power,Bid):
...
#-------------write master         
            ...
            while count<last:                
                ...
                lambdaa = WriteEnumeration(flow_list, congested_list, revtrans,lmp,Phi,Psineg,Psipos,Profit,power,Bid)
                ...
                if fijzero == False:         
                        ...
                        collusives = Updatecollusives(collusives,col,lambdaa,DCOPF_matrix,count) #olması gereken  
                        if len(collusives) == 0:
                                 colprevstate = 0
                                 break
            ...
            mastermatrix[prob] = [totprof,pencost,transrevenue,colprevstate,sure,countmaster, countenum,count]
            #if prob == 10:       
       ...
       with open(output_file3,"a") as f:   
                    f.write(str(round(alpha1,1)) + '\t' + str(round(alpha2,1)) + '\t' + str(round(alpha3,1)) + "\t"+ str(colscore) + "\t"+ str(tottime)+ 
                            "\t"+ str(totmaster)+"\t"+ str(totenum)+"\t"+ str(totiter)+"\n")